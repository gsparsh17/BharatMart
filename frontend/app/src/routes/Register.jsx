...
function Register() {
  ...
  return (
    <div className='absolute w-full bg-sky-500 mt-[4vw]'>
      <img className='absolute' src={bg} alt="" />
      <div className="absolute w-full flex justify-center">
        <div className="lg:w-[50vw] pb-10 pt-5 p-4 flex flex-wrap justify-center shadow-2xl my-20 rounded-md bg-white">
          <div className="pb-5">
