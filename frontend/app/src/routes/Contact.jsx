...
function Contact() {
  return (
    <div className='absolute w-full h-screen bg-sky-500 flex justify-center'>
      <img className='absolute' src={bg} alt="" />
      <div className=" absolute py-[2vw] px-[2vw] mx-auto max-w-screen-md mt-[10vw] bg-white rounded-xl shadow-xl"> 
